...
```{r}
pairwise_bray_df <- extract_pairwise_permanova(pairwise_permanova_bray, "Bray-Curtis")
pairwise_jaccard_df <- extract_pairwise_permanova(pairwise_permanova_jaccard, "Jaccard")

pairwise_perm_table <- rbind(pairwise_bray_df, pairwise_jaccard_df)

kable(pairwise_perm_table,
      caption = "Pairwise PERMANOVA results (999 permutations)",
      col.names = c("Comparison", "R²", "F-value", "p-value", "Distance"),
      digits = 4,
      row.names = FALSE,
      booktabs = TRUE)
```
